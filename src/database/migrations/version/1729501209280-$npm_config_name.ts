...
export class  $npmConfigName1729501209280 implements MigrationInterface {
    name = ' $npmConfigName1729501209280'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "point" ("id" SERIAL NOT NULL, "points" integer NOT NULL, "earnedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_391f59a9491a08961038a615371" PRIMARY KEY ("id"))`);
